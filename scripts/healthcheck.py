...
SERVICES = {
    "Ollama-Reasoning": (
        os.getenv("OLLAMA_REASONING_URL", "http://localhost:12009/"),
        {},
        False,
    ),
    "Ollama-Agentic": (
        os.getenv("OLLAMA_AGENTIC_URL", "http://localhost:12013/"),
        {},
        False,
    ),
    "Ollama-Coding": (
        os.getenv("OLLAMA_CODING_URL", "http://localhost:12014/"),
        {},
        False,
    ),
    "MoE-Router": (
        os.getenv("MOE_ROUTER_URL", "http://localhost:12016/docs"),
        {},
        False,
    ),
    "Guardrails": (
